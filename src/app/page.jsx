...
export default function Home() {
  const trendingCourses = [
    { title: "Data Science Fundamentals", instructor: "Dr. James Wilson", image: "https://images.unsplash.com/photo-1551288049-bbbda536339a?q=80&w=800&auto=format&fit=crop", category: "Data Science" },
    { title: "Leadership Strategies", instructor: "Elena Rodriguez", image: "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=800&auto=format&fit=crop", category: "Business" },
    { title: "Advanced SEO 2024", instructor: "David Kim", image: "https://images.unsplash.com/photo-1562577353-f5f24253cd73?q=80&w=800&auto=format&fit=crop", category: "Marketing" },
    { title: "AWS Architect Mastery", instructor: "Sofia Patel", image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=800&auto=format&fit=crop", category: "Cloud" }
  ];

  const instructors = [
    { name: "Dr. James Wilson", role: "Senior AI Researcher", image: "https://i.pravatar.cc/150?u=james" },
    { name: "Elena Rodriguez", role: "Lead Product Designer", image: "https://i.pravatar.cc/150?u=elena" },
    { name: "David Kim", role: "Marketing Strategist", image: "https://i.pravatar.cc/150?u=david" },
    { name: "Sofia Patel", role: "Cloud Infrastructure Lead", image: "https://i.pravatar.cc/150?u=sofia" }
  ];
        ...
        <section className="pt-24 overflow-hidden">
          <div className="container-custom flex flex-col md:flex-row items-center gap-24">
            ...
            >
              <Image
                alt="Hero Image"
                className="rounded-[40px] shadow-2xl w-full object-cover aspect-[4/3] border-[12px] border-white"
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 h-auto md:h-[550px]">
            ...
            >
              ...
              <p className="text-white/80 font-medium leading-relaxed max-w-md">Maximize focus by breaking your study sessions into 25-minute intervals of deep work followed by short breaks.</p>
            </motion.div>
            {/* Right Column */}
            <div className="md:col-span-5 flex flex-col gap-8">
              ...
              >
                ...
                <p className="text-white/90 text-sm font-medium leading-relaxed">Review material at increasing intervals to solidify long-term memory retention.</p>
              </motion.div>
              {/* Two Bottom Boxes */}
